...
seo-title: Ler todos os POIs em uma biblioteca
description: Leia todos os POIs em uma biblioteca usando as APIs REST do Places.
seo-description: Leia todos os POIs em uma biblioteca usando as APIs REST do Places.
...
>[!IMPORTANT]
>
>Substitua '', `<API KEY>`, `<TOKEN>`e `<ORGID>` pelos valores reais.
