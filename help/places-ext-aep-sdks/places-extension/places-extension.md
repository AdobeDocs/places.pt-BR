...
Navegue até o portal do desenvolvedor do Adobe para exibir a documentação das [extensões do SDK do Places](https://developer.adobe.com/client-sdks/documentation/places/).
...
1. Complete the publishing process to update the SDK configuration.
   ...
   For more information about publishing in Experience Platform Launch, see [Publishing](https://experienceleague.adobe.com/docs/experience-platform/tags/publish/overview.html?lang=pt-BR).
