---
title: Atualizar vários POIs
seo-title: Atualizar vários POIs
description: Use as APIs em lote para atualizar vários POIs.
seo-description: Use as APIs em lote para atualizar vários POIs.
...
# Atualizar vários POIs {#update-multiple-pois}

Um método POST que permite atualizar vários POIs.
...
>[!IMPORTANT]
>
>Substitua `<API KEY>`, `<TOKEN>`e `<ORGID>`e `<PATHTOBATCHUPDATEJSONFILE>` por valores reais.

## Exemplo de arquivo JSON

Este é o exemplo de arquivo JSON para a `batchUpdate` API:
